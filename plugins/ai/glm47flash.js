...
module.exports = {
  ...
  name:        'GLM-4-Flash AI',
  category:    'Ai',
  path:        '/api/ai/glm4flash',
  method:      'GET',
  description: `Model AI GLM-4-Flash dari Z.ai (Zhipu). Respons cepat untuk chat umum, tanya jawab, dan terjemahan.`,
  ...
  handler: async (req, getInput) => {
    ...
    try {
      const res = await fetch('https://api.siputzx.my.id/api/ai/glm47flash?prompt=' + encodeURIComponent(prompt) + '&system=' + encodeURIComponent(system) + '&temperature=' + encodeURIComponent(temperature) , {
