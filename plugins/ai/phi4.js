...
module.exports = {
  ...
  path:        '/api/ai/phi4',
  method:      'GET',
  description: `Model Microsoft Phi-4. Small LM dengan performa luar biasa untuk reasoning dan coding.`,

  params: [
    {
      name: 'prompt',
      required: true,
      example: 'Tulis fungsi bubble sort di Python.',
  ...
  handler: async (req, getInput) => {
    ...
    try {
      const res = await fetch('https://api.siputzx.my.id/api/ai/phi4?prompt=' + encodeURIComponent(prompt) + '&system=' + encodeURIComponent(system) + '&temperature=' + encodeURIComponent(temperature) , {
