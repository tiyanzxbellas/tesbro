// File: plugins/download/snaptik-v2.js
'use strict';

const axios = require('axios');

module.exports = {
  id:          'download-snaptik-v2',
  name:        'Snaptik-v2',
  category:    'Download',
  path:        '/api/download/snaptik-v2',
  method:      'GET',
  description: 'SnapTik video fetch',
  ...
  handler: async (req, getInput, res) => {
    ...
    try {
      const { data } = await axios.get('https://api.neoxr.eu/api/snaptik-v2', {
        params: {
          url,
          apikey: 'yMb35i',
        },
