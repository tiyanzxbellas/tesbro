...
module.exports = {
  ...
  description: 'Menampilkan soal teka-teki logika atau plesetan beserta jawabannya.',
  params: [],
  handler: async (requestParameter, getInputFunction, responseObject) => {
    try {
      const upstreamUrl = 'https://api.siputzx.my.id/api/games/tekateki';
      ...
      if (responseData.status !== true || !responseData.data) return { ok: false, status: 404, message: 'Data teka-teki tidak ditemukan.' };
